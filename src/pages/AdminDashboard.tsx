      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <Tabs defaultValue="students" className="space-y-6">
          <TabsList className="grid w-full grid-cols-5 text-xs">
            ...
            <TabsTrigger value="coach-attendance">Coach Attendance</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="student-attendance">
            <Card>
              <CardHeader>
                ...
                <CardDescription className="text-sm">View student attendance with batch/group (Jan 25, 2024)</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
          ...
          <TabsContent value="coach-attendance">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center text-lg">
                ...
                <CardDescription className="text-sm">View coach entry/exit times and locations (Jan 25, 2024)</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
