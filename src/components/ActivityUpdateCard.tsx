        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Share session highlights</p>
            </div>
          </div>
          <Button
            onClick={() => setShowForm(!showForm)}
            size="sm"
            className="h-10 px-4 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg font-medium"
          >
